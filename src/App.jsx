...
export default function App() {
  ...
  // Corte predefinido: 8:00am o 4:30pm según hora actual
  const ahora = new Date();
  const hora = ahora.getHours() + ahora.getMinutes() / 60;
  const fechaHoy = ahora.toLocaleDateString("es-PE", { day: "2-digit", month: "2-digit", year: "2-digit" });
  const corteLabel = hora < 12 ? `${fechaHoy} · 8:00 am` : `${fechaHoy} · 4:30 pm`;
